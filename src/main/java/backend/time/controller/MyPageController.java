...
import backend.time.dto.KakaoDto;
...
public class MyPageController {
     ...
     */
    @GetMapping("/chat")
    public Result findRoomsByMemberPage(@RequestBody KakaoDto kakaoDto){
        // 1. 채팅 목록 조회 SELECT
        List<ChatRoom> chatRoomList = chattingService.findChatRoomByMember(kakaoDto.getKakaoId());
